...
INSERT INTO `pointlogs` (`id`, `point`, `updateTime`, `rId`, `pId`, `amount`) VALUES
(0, 1000, '2022-10-29 03:51:30', 0, NULL, NULL),
(1, -100, '2022-10-29 03:04:28', NULL, 1, 10),
(2, 1000, '2022-10-29 03:55:49', 1, NULL, NULL);
...
(0, '列印成績單費10元折抵券', '可抵免10元手續費，不得連續使用，於學務處兌換', 1978, 100, '2022-11-09 20:00:26', '2022-11-09 20:00:26', 1, 'A123456789', '2023-02-09 20:00:00', 'uploads/1667995226.jpg'),
...
('B10856056', '羅文佑', '1234', 'H123456789', '2022-06-02 00:00:00', 2, 0, 0, 0, 0, 0, 0, 62300),
('B12345678', '王曉明', '123', 'H987654321', '2022-11-17 19:59:46', 2, 0, 0, 0, 0, 0, 0, 5000);
...
(1, 'B10856056', 1, 2, '2022-11-18 11:26:46', 3),
(2, 'B10856056', 2, 1, '2022-11-18 11:26:52', 3),
(3, 'B10856056', 0, 3, '2022-11-18 11:26:59', 1),
...
INSERT INTO `uselogs` (`transactionTime`, `pId`, `sId`, `amount`, `oId`) VALUES
('2022-10-01 06:01:07', 1, 'B10856056', 10, 1);
...
-- 資料表索引 `pointlogs`
--
ALTER TABLE `pointlogs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_prize_pId` (`pId`),
  ADD KEY `FK_rewardslogs_rId` (`rId`);
...
--
ALTER TABLE `uselogs`
  ADD PRIMARY KEY (`transactionTime`),
...
--
ALTER TABLE `pointlogs`
  ADD CONSTRAINT `FK_prize_pId` FOREIGN KEY (`pId`) REFERENCES `prize` (`pId`),
  ADD CONSTRAINT `FK_rewardslogs_rId` FOREIGN KEY (`rId`) REFERENCES `rewardslogs` (`rId`);
