    ...
    <div class="container">
        ...
        <div class="rightDiv">
            ...
            <div class="search">
                ...
                <td><input type="button" class="btn btn-primary" name="searchBtn" id="searchBtn" value="查詢資料庫" onclick="search()"></td>
                <td><input type="button" class="btn btn-danger" name="searchBtn" id="searchBtn" value="上傳區塊鏈" onclick="search()"></td>
                <td><input type="button" class="btn btn-success" name="searchBtn" id="searchBtn" value="查詢區塊鏈" onclick="search()"></td>
            </table>
            </div>
                <!--查詢資料庫按鈕:按下查詢後輸出資料-->
